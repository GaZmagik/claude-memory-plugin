...
• Before destructive operations (rm, mv on important paths): run /check-gotchas or invoke memory-recall agent
...
• To record learnings: Use ~/.claude/skills/memory/memory.sh write with JSON payload
