...
flowchart TB
  ...
  learning-retro-memory-curation-linking-orphan-elimination-created-legitimate-system-value(["learning-retro-memory-curation-linking-orphan-elimination-created-legitimate-system-value"])
  ...
  learning-retro-memory-curation-linking-orphan-elimination-created-legitimate-system-value -->|rel| hub-core-module-hub
  learning-retro-memory-curation-linking-orphan-elimination-created-legitimate-system-value -->|rel| artifact-memory-system-architecture-reference
  hub-core-module-hub -->|aut| hub-graph-module-hub
  hub-graph-module-hub -->|aut| hub-core-module-hub
  learning-retro-orphaned-nodes-accumulate-post-compaction -->|aut| learning-retro-memory-curation-linking-orphan-elimination-created-legitimate-system-value
  learning-retro-memory-curation-linking-orphan-elimination-created-legitimate-system-value -->|aut| learning-retro-orphaned-nodes-accumulate-post-compaction
  learning-retro-memory-graph-linking-batch-approach-efficient -->|aut| learning-retro-orphaned-nodes-accumulate-post-compaction
  learning-retro-orphaned-nodes-accumulate-post-compaction -->|aut| learning-retro-memory-graph-linking-batch-approach-efficient
